...
plot1.title("Light frequency 1 in dependence to photosynthetic activity")
...
plot2.title("Light frequency 2 in dependence to photosynthetic activity")
...
plot3.title("Light frequency 2 in dependence to photosynthetic activity")
